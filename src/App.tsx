...
function App(): JSX.Element {
  ...
  return (
    <div className="min-h-screen bg-dark-900 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div
        className={`fixed bottom-0 left-0 right-0 bg-dark-700 border-t border-dark-600 duration-300 ${
      ...
      >
        <div className="max-w-6xl mx-auto p-4 flex items-center justify-between">
          <div className="flex items-center">
            ...
            <span className="text-xs xs:text-2xl text-blue-800 ml-4 mr-1">
              £
            </span>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button className="px-6 py-2 bg-blue-600 text-white text-xs xs:text-base rounded-lg hover:bg-blue-700 flex items-center">
              Continue →
            </button>
          </div>
        </div>
